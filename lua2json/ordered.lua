-- Retrieved from http://lua-users.org/wiki/OrderedTable on 2020-10-11
-- Ordered Table
...
-- Lua 5.1 doesn't have __pairs
local _p = pairs;
function pairs(t, ...)
  -- Original function suggested on L69 broke if metatable was nil
  local meta = getmetatable(t)
  if (meta == nil)
  then
    return _p(t, ...)
  else
    return (getmetatable(t).__pairs or _p)(t, ...)
  end
end
